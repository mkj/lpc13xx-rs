#[doc = "Reader of register BEMR"]
pub type R = crate::R<u32, super::BEMR>;
#[doc = "Writer for register BEMR"]
pub type W = crate::W<u32, super::BEMR>;
#[doc = "Register BEMR `reset()`'s with value 0"]
impl crate::ResetValue for super::BEMR {
    type Type = u32;
    #[inline(always)]
