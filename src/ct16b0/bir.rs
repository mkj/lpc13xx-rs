#[doc = "Reader of register BIR"]
pub type R = crate::R<u32, super::BIR>;
#[doc = "Writer for register BIR"]
pub type W = crate::W<u32, super::BIR>;
#[doc = "Register BIR `reset()`'s with value 0"]
impl crate::ResetValue for super::BIR {
    type Type = u32;
    #[inline(always)]
