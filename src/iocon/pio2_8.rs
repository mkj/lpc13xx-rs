#[doc = "Reader of register PIO2_8"]
pub type R = crate::R<u32, super::PIO2_8>;
#[doc = "Writer for register PIO2_8"]
pub type W = crate::W<u32, super::PIO2_8>;
#[doc = "Register PIO2_8 `reset()`'s with value 0xd0"]
impl crate::ResetValue for super::PIO2_8 {
    type Type = u32;
    #[inline(always)]
