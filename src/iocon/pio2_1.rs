#[doc = "Reader of register PIO2_1"]
pub type R = crate::R<u32, super::PIO2_1>;
#[doc = "Writer for register PIO2_1"]
pub type W = crate::W<u32, super::PIO2_1>;
#[doc = "Register PIO2_1 `reset()`'s with value 0xd0"]
impl crate::ResetValue for super::PIO2_1 {
    type Type = u32;
    #[inline(always)]
