#[doc = "Reader of register PIO2_2"]
pub type R = crate::R<u32, super::PIO2_2>;
#[doc = "Writer for register PIO2_2"]
pub type W = crate::W<u32, super::PIO2_2>;
#[doc = "Register PIO2_2 `reset()`'s with value 0xd0"]
impl crate::ResetValue for super::PIO2_2 {
    type Type = u32;
    #[inline(always)]
