#[doc = "Reader of register WDTCLKUEN"]
pub type R = crate::R<u32, super::WDTCLKUEN>;
#[doc = "Writer for register WDTCLKUEN"]
pub type W = crate::W<u32, super::WDTCLKUEN>;
#[doc = "Register WDTCLKUEN `reset()`'s with value 0"]
impl crate::ResetValue for super::WDTCLKUEN {
    type Type = u32;
    #[inline(always)]
