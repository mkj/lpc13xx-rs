...
pub enum CLKS_A {
    ...
    _11_CLOCKS__10_BITS = 0,
    #[doc = "1: 10 clocks / 9 bits"]
    _10_CLOCKS__9_BITS = 1,
...
impl CLKS_R {
    ...
    pub fn variant(&self) -> CLKS_A {
        match self.bits {
            0 => CLKS_A::_11_CLOCKS__10_BITS,
            1 => CLKS_A::_10_CLOCKS__9_BITS,
            2 => CLKS_A::_9_CLOCKS__8_BITS,
            3 => CLKS_A::_8_CLOCKS__7_BITS,
            4 => CLKS_A::_7_CLOCKS__6_BITS,
            5 => CLKS_A::_6_CLOCKS__5_BITS,
            6 => CLKS_A::_5_CLOCKS__4_BITS,
            7 => CLKS_A::_4_CLOCKS__3_BITS,
            _ => unreachable!(),
        }
    }
    #[doc = "Checks if the value of the field is `_11_CLOCKS__10_BITS`"]
    #[inline(always)]
    pub fn is_11_clocks__10_bits(&self) -> bool {
        *self == CLKS_A::_11_CLOCKS__10_BITS
    }
    #[doc = "Checks if the value of the field is `_10_CLOCKS__9_BITS`"]
    #[inline(always)]
    pub fn is_10_clocks__9_bits(&self) -> bool {
        *self == CLKS_A::_10_CLOCKS__9_BITS
    }
    #[doc = "Checks if the value of the field is `_9_CLOCKS__8_BITS`"]
    #[inline(always)]
    pub fn is_9_clocks__8_bits(&self) -> bool {
        *self == CLKS_A::_9_CLOCKS__8_BITS
    }
    #[doc = "Checks if the value of the field is `_8_CLOCKS__7_BITS`"]
    #[inline(always)]
    pub fn is_8_clocks__7_bits(&self) -> bool {
        *self == CLKS_A::_8_CLOCKS__7_BITS
    }
    #[doc = "Checks if the value of the field is `_7_CLOCKS__6_BITS`"]
    #[inline(always)]
    pub fn is_7_clocks__6_bits(&self) -> bool {
        *self == CLKS_A::_7_CLOCKS__6_BITS
    }
    #[doc = "Checks if the value of the field is `_6_CLOCKS__5_BITS`"]
    #[inline(always)]
    pub fn is_6_clocks__5_bits(&self) -> bool {
        *self == CLKS_A::_6_CLOCKS__5_BITS
    }
    #[doc = "Checks if the value of the field is `_5_CLOCKS__4_BITS`"]
    #[inline(always)]
    pub fn is_5_clocks__4_bits(&self) -> bool {
        *self == CLKS_A::_5_CLOCKS__4_BITS
    }
    #[doc = "Checks if the value of the field is `_4_CLOCKS__3_BITS`"]
    #[inline(always)]
    pub fn is_4_clocks__3_bits(&self) -> bool {
        *self == CLKS_A::_4_CLOCKS__3_BITS
    }
}
...
impl<'a> CLKS_W<'a> {
    ...
    #[inline(always)]
    pub fn _11_clocks__10_bits(self) -> &'a mut W {
        self.variant(CLKS_A::_11_CLOCKS__10_BITS)
    }
    #[doc = "10 clocks / 9 bits"]
    #[inline(always)]
    pub fn _10_clocks__9_bits(self) -> &'a mut W {
        self.variant(CLKS_A::_10_CLOCKS__9_BITS)
    }
    #[doc = "9 clocks / 8 bits"]
    #[inline(always)]
    pub fn _9_clocks__8_bits(self) -> &'a mut W {
        self.variant(CLKS_A::_9_CLOCKS__8_BITS)
    }
    #[doc = "8 clocks / 7 bits"]
    #[inline(always)]
    pub fn _8_clocks__7_bits(self) -> &'a mut W {
        self.variant(CLKS_A::_8_CLOCKS__7_BITS)
    }
    #[doc = "7 clocks / 6 bits"]
    #[inline(always)]
    pub fn _7_clocks__6_bits(self) -> &'a mut W {
        self.variant(CLKS_A::_7_CLOCKS__6_BITS)
    }
    #[doc = "6 clocks / 5 bits"]
    #[inline(always)]
    pub fn _6_clocks__5_bits(self) -> &'a mut W {
        self.variant(CLKS_A::_6_CLOCKS__5_BITS)
    }
    #[doc = "5 clocks / 4 bits"]
    #[inline(always)]
    pub fn _5_clocks__4_bits(self) -> &'a mut W {
        self.variant(CLKS_A::_5_CLOCKS__4_BITS)
    }
    #[doc = "4 clocks / 3 bits"]
    #[inline(always)]
    pub fn _4_clocks__3_bits(self) -> &'a mut W {
        self.variant(CLKS_A::_4_CLOCKS__3_BITS)
    }
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
